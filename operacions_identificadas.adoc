...
| 153|Empleados contacto animal |Obtener una lista con todos los empleados que han tenido contacto con un animal determinado |EMPLEADO, ALIMENTA, CUIDA, VACUNA, ANIMAL | NO
| | | | |
| | | | |
| | | | |
| | | | |
