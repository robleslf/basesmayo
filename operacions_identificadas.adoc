...
|173 |Animal por especie más antiguo en cada zona |Ver quién es el animal de una determinada especie que lleva viviendo más tiempo en cada zona del zoo |ANIMAL, VIVE |NO
|173 |Animal por especie más nuevo en cada zona |Ver quién es el animal de una determinada especie que lleva viviendo menos tiempo en cada zona del zoo |ANIMAL, VIVE |NO
| | | | |
| | | | |
| | | | |
| | | | |
