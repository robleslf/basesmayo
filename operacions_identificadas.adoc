...
|182 |Miembro en la primera visita |Hacer miembro a un cliente que visita el zoológico por primera vez, y es por tanto registrado como cliente y se le abre un registro en la tabla MEMBRESIA |MEMBRESIA, CLIENTE |SÍ
