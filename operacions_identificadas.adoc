...
| 153|Empleados contacto animal |Obtener una lista con todos los empleados que han tenido contacto con un animal determinado junto con un teléfono de contacto para poder comunicarse con ellos (en caso de tener más de un teléfono, se escogerá el número más pequeño)|EMPLEADO, ALIMENTA, CUIDA, VACUNA, ANIMAL | NO
| | | | |
| | | | |
| | | | |
| | | | |
