...
|172 |Animales más antiguos por especie |Buscar qué animales de la misma zona son más nuevos que un animal determinado; por ejemplo, qué animales han entrado al zoo después del último gorila ingresado | ANIMAL |NO
| | | | |
| | | | |
| | | | |
| | | | |
