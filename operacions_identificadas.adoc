...
|172 |Animales más antiguos por especie |Buscar qué animales de la misma zona son más nuevos que un animal determinado | ANIMAL |NO
| | |= Operaciones identificadas
...
|171 |Animales más nuevos por especie |Buscar qué animales de la misma especie son más nuevos que un animal determinado | ANIMAL |NO
|172 |Animales más antiguos por especie |Buscar qué animales de la misma zona son más nuevos que un animal determinado | ANIMAL |NO
| 173|Animales posteriores a especie |Animales que han ingresado al zoo más tarde que el último animal ingresado de una determinada especie |ANIMAL |NO
| | | | |
| | | | |
| | | | |
| | | | |
